...
Now, let’s add some styles for `Layout`. To do so, we’ll use [CSS Modules](/docs/basic-features/built-in-css-support#adding-component-level-css), which lets you import CSS files in a React component.
...
<AnswerBox
  meta={meta}
  answers={['CSS Modules', 'Sass', 'styled-jsx', 'styled-components']}
